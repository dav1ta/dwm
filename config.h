...
static const char *fonts[]          = { "Dejavu Sans Mono Nerd Font:size=13" };
...
static const char col_orange[]       = "#f99e03";
...
static const char *termcmdfloat[]  = { "st", "-t","st_float","-g", "130x35", NULL };
